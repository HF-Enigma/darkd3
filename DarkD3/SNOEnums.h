#ifndef _SNO_ENUMS_H_
#define _SNO_ENUMS_H_
...
enum SNOGroupOffset
{
	SNOGroup_Scene_Addr			= 0x1D27418,	//2.0.0.20874
	SNOGroup_StringList_Addr	= 0x1CC2FE0,	//2.0.0.20874
	//SNOGroup_Actors_Addr		= 0x18C3308,
	SNOGroup_GameBalance_Addr	= 0x1CC8DA0		//2.0.0.20874
};
...
enum SNOGBType
{
	GBType_ItemTypes = 1,
	GBType_Items = 2,
	GBType_ExperienceTable = 3,
	GBType_HelpCodes = 24,
	GBType_MonsterLevels = 5,
	GBType_Heros = 7,
	GBType_AffixList = 8,
	GBType_MovementStyles = 10,
	GBType_Labels = 11,
	GBType_LootDistribution = 12,
	GBType_RareItemNames = 16,
	GBType_MonsterAffixes = 18,
	GBType_MonsterNames = 19,
	GBType_SocketedEffects = 21,
	GBType_ItemEnhancements = 23,
	GBType_ItemDropTable = 25,
	GBType_ItemLevelModifiers = 26,
	GBType_QualityClasses = 27,
	GBType_Scenery = 17,
	GBType_Hirelings = 4,
	GBType_SetItemBonuses = 33,
	GBType_EliteModifiers = 34,
	GBType_ItemTiers = 35,
	GBType_PowerFormulaTables = 36,
	GBType_Recipes = 32,
	GBType_ScripedAchievementEvents = 37
};
...
enum PowerIds : DWORD
{
	...
	//Axe_Bad_Data = 30020,
	Axe_Operate_Gizmo = 30021,					//Interact with object
	Axe_Operate_NPC = 30022,					//Interact with NPC
